<script lang="ts">
  ...
  import { Shield, MessageCircle, FileText, CheckCircle2, User, ArrowLeft } from "@lucide/svelte";

  // State for staff feature card (switching between list and detail view internally)
  let staffView = $state('list'); // 'list' | 'profile'
  let profileUser = $state('Lena');
  let profileRole = $state('Responsable Staff');
  let profileAvatar = $state('Lena');

  // Sandbox active tab state (for the interactive playground at the bottom)
...
<div class="min-h-screen relative overflow-hidden text-gray-800 font-sans">
  ...
  <section class="max-w-[90rem] mx-auto px-8 pt-12 lg:pt-20 pb-24 lg:pb-36 relative">
    ...
    <div class="max-w-4xl mx-auto text-center mb-16 relative z-20">
      <h1 class="text-5xl md:text-7xl font-black tracking-tighter leading-[1.05] mb-8 text-gray-900">
        Le centre de contrôle de ta <br class="hidden md:inline"/> <MarkerCircle color="blue" class="text-indigo-600">communauté</MarkerCircle>.
      </h1>
      <p class="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto font-bold">
    ...
    <!-- Centered Hero Graphics (Enormous Interactive Profile Mockup) -->
    <div class="flex justify-center items-center relative w-full z-10">
      <div class="relative w-full max-w-[1240px]">
        <!-- Post-it pointing to the profile mockup -->
        ...
        <!-- Sticky Tapes holding the browser mockup to the whiteboard -->
        ...
        <div class="relative w-full h-[750px] md:h-[840px] rounded-2xl shadow-[0_35px_80px_rgba(0,0,0,0.16)] flex flex-col overflow-hidden bg-white border border-gray-200/80 z-10">
          ...
          <!-- Browser-like header bar to contextualize and integrate -->
          <div class="flex items-center gap-2 px-5 py-3.5 bg-gray-50/80 border-b border-gray-200/60 select-none shrink-0">
            ...
            <!-- dummy space to balance macOS buttons -->
  ...
  <section class="border-y-2 border-gray-200 bg-white/50 backdrop-blur-sm relative overflow-hidden py-24">
    ...
    <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
      ...
      <!-- Horizontal layout flow of the mess -->
  ...
  <section id="features" class="py-32 relative bg-white">
    <div class="max-w-[90rem] mx-auto px-8">
      ...
      <!-- Feature 3: Detailed Profile Tabs (User Profile) -->
  ...
  <section id="demo" class="py-32 bg-gray-50 border-y border-gray-200 relative">
    <div class="max-w-[70rem] mx-auto px-8 text-center mb-16">
    ...
    <div class="max-w-[75rem] mx-auto px-6 relative">
  ...
  <!-- Dans la vraie vie (Workflow) -->
  <section id="workflow" class="py-32 bg-gray-900 text-white relative">
    <div class="max-w-5xl mx-auto px-6">
      <h2 class="text-4xl md:text-5xl font-black tracking-tight mb-24 text-center font-headline">Dans la vraie vie, ça donne quoi ?</h2>
      
      <div class="relative pl-8 md:pl-0">
        <!-- Vertical line -->
        <div class="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 bg-gray-800 md:-translate-x-1/2"></div>
        
        <!-- Step 1 -->
        <div class="relative flex flex-col md:flex-row items-center mb-24">
        ...
        <!-- Step 2 -->
        <div class="relative flex flex-col md:flex-row-reverse items-center mb-24">
